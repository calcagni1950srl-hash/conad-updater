...
def main():
    ...
    ap.add_argument("--audit", default="sole365_audit.json")
    args = ap.parse_args()
    ...
    audit = {
        "engine": "SOLE365_ENGINE_ANTIBLOCCO",
    ...
    metadata = {
        ...
        "catalog_engine": "SOLE365_ENGINE_ANTIBLOCCO",
        "base_site_id": args.site,
    ...
    duplicates = con.execute(
        "SELECT COUNT(*) FROM ("
        "SELECT product_id, COUNT(*) c FROM products "
    ...
    audit.update(
        {
            "verdict": "SOLE365_ENGINE_ANTIBLOCCO_VALIDATED",
